...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrieves the html elemet id that was clicked.
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
        //If activePlayer is anthing other than 'X'.
        } else {
            activePlayer = 'X';
        }
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //retutned and our else if condition executes the drawWinLine function.
...
function drawWinLines(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This method indicates the ned point in our line.
        c.lineTo(x, y);
    ...
    //This function clears our canvas after our win lne is drawn.
    function clear() {
    ...
    //Then, clear canvas, reset game and allows clicking again.
